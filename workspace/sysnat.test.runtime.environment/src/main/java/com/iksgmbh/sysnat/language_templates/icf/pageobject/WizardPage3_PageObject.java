 ...
 */
public class WizardPage3_PageObject implements PageObject
{	
	private static final int WIZARD_PAGE_NUMBER = 3;

	private ExecutableExample testCase;

	public WizardPage3_PageObject(ExecutableExample aTestCase) {
