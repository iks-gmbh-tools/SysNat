 ...
 */
public class WizardPage4_PageObject implements PageObject
{	
	private static final int WIZARD_PAGE_NUMBER = 4;

	private ExecutableExample testCase;

	public WizardPage4_PageObject(ExecutableExample aTestCase) {
