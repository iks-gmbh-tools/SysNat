...
public class NaturalLanguageTemplatePatternTest 
{
	...
	public void createsSimpleNaturalLanguagePattern() throws Exception 
	{
		...
		assertEquals("pattern", "Natural language instruction without parameter.", (String)languagePattern.getPart(0).value);
	}
	...
	{		
		// arrange 
		final Class<?> c = Class.forName("com.iksgmbh.sysnat.test.templateContainer.LanguageTemplateContainerFailingTestImpl");
	...
	{
		// arrange 
		final Class<?> c1 = Class.forName("com.iksgmbh.sysnat.test.templateContainer.LanguageTemplateContainerTestImpl");
		final Method method1 = c1.getMethod("methodWithFourParameters", String.class, String.class, String.class, String.class);
		final LanguageTemplatePattern languagePattern1 = new LanguageTemplatePattern(method1, new Filename("test1"), "" );
		final Class<?> c2 = Class.forName("com.iksgmbh.sysnat.test.templateContainer.LanguageTemplateContainer2TestImpl");
