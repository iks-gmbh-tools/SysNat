 ...
 */
public class SimpleGreetingTest extends TestCaseTemplateParent
{
	...
	public void executeTestCase() 
	{
		try {
			...
			languageTemplatesCommon.createComment("Nothing_to_arrange.");
			...
			languageTemplatesHelloWorldSpringBootBasics.isDislayedTextCorrect("GreetingResult", "Hello World!");
