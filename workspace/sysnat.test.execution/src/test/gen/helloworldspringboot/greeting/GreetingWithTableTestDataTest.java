 ...
 */
public class GreetingWithTableTestDataTest extends TestCaseTemplateParent
{
	...
	public void executeTestCase() 
	{
		try {
			...
			languageTemplatesCommon.checkFilterCategory("<Pfad>,Smoketest");
			languageTemplatesCommon.setDatasetObject("Datasets in columns<Line Separator>|Name|Susi|<Line Separator>|Greeting|Hi|<Line Separator>|GreetingResult|Hi Susi!|");
