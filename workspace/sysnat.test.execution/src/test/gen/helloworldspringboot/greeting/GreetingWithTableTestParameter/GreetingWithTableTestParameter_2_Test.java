 ...
 */
public class GreetingWithTableTestParameter_2_Test extends TestCaseTemplateParent
{
	...
	public void executeTestCase() 
	{
		try {
			...
			languageTemplatesCommon.setDatasetObject("Datasets in columns<Line Separator>|Name|Bob|<Line Separator>|GreetingResult|Hello Bob!|<Line Separator>|Greeting|Hello|");
