 ...
 */
public class TestDataBasedGreeting1Test extends TestCaseTemplateParent
{
	...
	public void executeTestCase() 
	{
		try {
			...
			languageTemplatesCommon.setDatasetObject("SingleGreetingData");
			...
			languageTemplatesHelloWorldSpringBootBasics.isDislayedTextCorrect("GreetingResult", "Hey Elisabeth!");
