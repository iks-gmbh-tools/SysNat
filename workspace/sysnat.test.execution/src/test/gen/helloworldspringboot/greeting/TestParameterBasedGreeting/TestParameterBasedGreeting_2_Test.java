 ...
 */
public class TestParameterBasedGreeting_2_Test extends TestCaseTemplateParent
{
	...
	public void executeTestCase() 
	{
		try {
			...
			languageTemplatesCommon.setDatasetObject("HelloWorldTestData_GreetingValidationData2");
