 ...
 */
public class TestParameterBasedGreeting_4_Test extends TestCaseTemplateParent
{
	...
	public void executeTestCase() 
	{
		try {
			...
			languageTemplatesCommon.setDatasetObject("HelloWorldTestData_GreetingValidationData4");
