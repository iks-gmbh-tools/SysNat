 ...
 */
public class TestParameterBasedGreeting_1_Test extends TestCaseTemplateParent
{
	...
	{
		try {
			languageTemplatesCommon.startNewXX("TestParameterBasedGreeting_1");
			languageTemplatesCommon.checkFilterCategory("<Pfad>");
			languageTemplatesCommon.setDatasetObject("HelloWorldTestData_GreetingValidationData1");
