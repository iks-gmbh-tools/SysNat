 ...
 */
public class TestDataBasedGreeting3Test extends TestCaseTemplateParent
{
	...
	public void executeTestCase() 
	{
		try {
			...
			languageTemplatesCommon.setDatasetObject("MultipleGreetingData_1");
			languageTemplatesCommon.setDatasetObject("MultipleValidationData_1");
			...
			languageTemplatesHelloWorldSpringBootBasics.isDislayedTextCorrect("GreetingResult", "MultipleValidationData_1:GreetingResult");
