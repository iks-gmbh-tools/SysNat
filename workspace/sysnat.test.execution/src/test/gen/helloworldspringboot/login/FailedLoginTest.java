 ...
 */
public class FailedLoginTest extends TestCaseTemplateParent
{
	...
	public void executeTestCase() 
	{
		try {
			...
			languageTemplatesHelloWorldSpringBootBasics.clickMainMenuItem("Logout");
			languageTemplatesHelloWorldSpringBootBasics.isPageVisible("Login Page");

			// act block
			languageTemplatesCommon.startNewTestPhase("Act");
			languageTemplatesHelloWorldSpringBootBasics.loginWith("Peter", "wrongPW");

			// assert block
			languageTemplatesCommon.startNewTestPhase("Assert");
			languageTemplatesHelloWorldSpringBootBasics.isPageVisible("Error Page");
			languageTemplatesHelloWorldSpringBootBasics.isDislayedTextCorrect("ErrorMessage", "Invalid User Login Data.");
			languageTemplatesCommon.startNewTestPhase("Reset to start situation");
			languageTemplatesHelloWorldSpringBootBasics.clickButton("Back");
			languageTemplatesHelloWorldSpringBootBasics.relogin();
