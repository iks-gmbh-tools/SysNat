 ...
 */
public class PruefeHauptmenuepunkteTest extends TestCaseTemplateParent
{
	...
	public void executeTestCase() 
	{
		try {
			...
			languageTemplatesCommon.createComment("-");
			...
			languageTemplatesCommon.createComment("-");
			languageTemplatesHomePageIKSBasics.clickMainMenuItem("Unternehmen");
			languageTemplatesHomePageIKSBasics.isPageVisible("Unternehmen");
			languageTemplatesCommon.createComment("-");
			languageTemplatesHomePageIKSBasics.clickMainMenuItem("Downloads");
			languageTemplatesHomePageIKSBasics.isPageVisible("Downloads");
			languageTemplatesCommon.createComment("-");
