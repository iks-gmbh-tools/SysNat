...
public class CommandLibraryCreator 
{
	...
	private static final String LIBRARY_PAGE_TEMPLATE = 
			"sources/sysnat.testcase.generation/src/main/resources/htmlTemplates/LanguageTemplateLibraryPage.htm.Template."
	...
	public void createLibrary() 
	{
		...
		commandLibraryFilename = SysNatFileUtil.findAbsoluteFilePath(commandLibraryFilename);
	...
	{
		final String pathAndFileName = SysNatFileUtil.findAbsoluteFilePath(LIBRARY_PAGE_TEMPLATE);
		final String templateText = SysNatFileUtil.readTextFileToString(pathAndFileName);
