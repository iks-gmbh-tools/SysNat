...
{
	private DocumentContent cut = new DocumentContent("../sysnat.test.runtime.environment/src/test/resources/PdfPageContentTestData/Pdf0.pdf");
	
	@Test
	public void analysesPdfWithWhitespace() throws Exception 
	{
		assertEquals("Page Number", 3, cut.getNumberOfPages() );
    ...
    {
    	cut = new DocumentContent("../sysnat.test.runtime.environment/src/test/resources/PdfPageContentTestData/IKS-Software-zum-Anfassen-Gibt-es-so-etwas.pdf");
    	
        assertEquals("Page Number", 8, cut.getNumberOfPages() );
