 ...
 */
package com.iksgmbh.sysnat.language_templates.sysnat.pageobject;
 ...
 */
public class MainFramePageObject extends PageObject
{	
	public MainFramePageObject(ExecutableExample executableExample, LanguageTemplateBasics aLanguageTemplateBasics) 
	{
		...
		idMappings = new HashMap<String, List<String>>();
		idMappings.put("GläubigerName", createList("GläubigerName"));
	...
	public boolean isCurrentlyDisplayed() {
		return executableExample.isElementAvailable("Datei");
	}

	public boolean clickDialogButtonIfAvailable(String buttonText)
	{
		SwingGuiController guiControl = (SwingGuiController) executableExample.getActiveGuiController();
		boolean available = guiControl.clickDialogButtonIfAvailable("!Achtung", buttonText, 1000, true);
		return available;
	}
