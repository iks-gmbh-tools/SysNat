...
public class TestDataBasedGreeting1Test extends SysNatTestCase
{
	...
	public void executeTestCase() 
	{
		try {		
			...
			languageTemplatesCommon.setTestData("SingleGreetingData");
			...
			languageTemplatesBasics_HelloWorldSpringBoot.isTextDislayed("GreetingResult", "Hey Elisabeth!");
