...
public class TestDataBasedGreeting3Test extends SysNatTestCase
{
	...
	public void executeTestCase() 
	{
		try {		
			...
			languageTemplatesCommon.setTestData("MultipleGreetingData_1");
			languageTemplatesCommon.setTestData("MultipleValidationData_1");
			...
			languageTemplatesBasics_HelloWorldSpringBoot.isTextDislayed("GreetingResult", "MultipleValidationData_1::GreetingResult");
