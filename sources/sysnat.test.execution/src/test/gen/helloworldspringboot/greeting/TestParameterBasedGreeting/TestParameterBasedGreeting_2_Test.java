...
public class TestParameterBasedGreeting_2_Test extends SysNatTestCase
{
	...
	{
		try {		
			languageTemplatesCommon.startNewXX("TestParameterBasedGreeting_2");
			languageTemplatesCommon.defineAndCheckExecutionFilter("<path>");
			languageTemplatesCommon.setTestData("HelloWorldTestData_GreetingValidationData2");
			...
			languageTemplatesBasics_HelloWorldSpringBoot.isTextDislayed("GreetingResult", "HelloWorldTestData_GreetingValidationData2::GreetingResult");
