...
public class TestParameterBasedGreeting_4_Test extends SysNatTestCase
{
	...
	{
		try {		
			languageTemplatesCommon.startNewXX("TestParameterBasedGreeting_4");
			languageTemplatesCommon.defineAndCheckExecutionFilter("<path>");
			languageTemplatesCommon.setTestData("HelloWorldTestData_GreetingValidationData4");
			...
			languageTemplatesBasics_HelloWorldSpringBoot.isTextDislayed("GreetingResult", "HelloWorldTestData_GreetingValidationData4::GreetingResult");
