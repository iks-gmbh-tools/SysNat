...
public class GreetingWithTableTestParameter_1_Test extends SysNatTestCase
{
	...
	public void executeTestCase() 
	{
		try {		
			...
			languageTemplatesCommon.setTestData("Datasets in columns<Line Separator>|Name|Susi|<Line Separator>|GreetingResult|Hi Susi!|<Line Separator>|Greeting|Hi|");
