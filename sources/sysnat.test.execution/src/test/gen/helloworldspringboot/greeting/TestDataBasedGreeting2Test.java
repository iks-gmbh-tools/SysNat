...
public class TestDataBasedGreeting2Test extends SysNatTestCase
{
	...
	public void executeTestCase() 
	{
		try {		
			...
			languageTemplatesCommon.setTestData("HelloWorldTestData");

			// arrange block
			languageTemplatesCommon.startNewTestPhase("Arrange");
			languageTemplatesBasics_HelloWorldSpringBoot.choose("HelloWorldTestData_GreetingValidationData1::Greeting", "Greeting");
			languageTemplatesBasics_HelloWorldSpringBoot.enterTextInField("HelloWorldTestData_GreetingValidationData1::Name", "Name");
			...
			languageTemplatesBasics_HelloWorldSpringBoot.isTextDislayed("GreetingResult", "HelloWorldTestData_GreetingValidationData1::GreetingResult");
