...
public class GreetingWithTableTestDataTest extends SysNatTestCase
{
	...
	public void executeTestCase() 
	{
		try {		
			...
			languageTemplatesCommon.setTestData("Datasets in columns<Line Separator>|Name|Susi|<Line Separator>|Greeting|Hi|<Line Separator>|GreetingResult|Hi Susi!|");
