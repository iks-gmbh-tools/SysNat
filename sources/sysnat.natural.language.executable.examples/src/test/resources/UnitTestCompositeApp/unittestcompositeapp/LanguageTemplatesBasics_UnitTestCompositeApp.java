...
public class LanguageTemplatesBasics_FakeCompositeApp extends LanguageTemplateBasics
{
    ...
    private LanguageTemplatesBasics_TestApp1 languageTemplatesBasicsTestApp1;
    private LanguageTemplatesBasics_TestApp2 languageTemplatesBasicsTestApp2;
   ...
   public LanguageTemplatesBasics_FakeCompositeApp(ExecutableExample anXX) 
	{
        ...
        this.languageTemplatesBasicsTestApp1 = new LanguageTemplatesBasics_TestApp1(executableExample);
        this.languageTemplatesBasicsTestApp2 = new LanguageTemplatesBasics_TestApp2(executableExample);
	...
	public void gotoStartPage() 
	{
		if (applicationInFocus == APP.TestApp1) {
			languageTemplatesBasicsTestApp1.gotoStartPage();
		} else {
			languageTemplatesBasicsTestApp2.gotoStartPage();
		}
	}
	...
	{
		if (applicationInFocus == APP.CompApp1) languageTemplatesBasics_CompApp1.clickMainMenuItem(mainMenuItem);
		else if (applicationInFocus == APP.CompApp2) languageTemplatesBasics_CompApp2.clickMainMenuItem(mainMenuItem);
	...
	{
		if (applicationInFocus == APP.CompApp1) languageTemplatesBasics_CompApp1.clickButton(buttonName);
		else if (applicationInFocus == APP.CompApp2) languageTemplatesBasics_CompApp2.clickButton(buttonName);
		else throw new RuntimeException("Unsupported application: " + applicationInFocus);
	}
	...
	{
		if (applicationInFocus == APP.CompApp1) languageTemplatesBasics_CompApp1.clickDialogButton(dialogName, buttonName);
		else if (applicationInFocus == APP.CompApp2) languageTemplatesBasics_CompApp2.clickDialogButton(dialogName, buttonName);
		else throw new RuntimeException("Unsupported application: " + applicationInFocus);
	}
	...
	{
		if (applicationInFocus == APP.CompApp1) languageTemplatesBasics_CompApp1.enterTextInField(valueCandidate, fieldName);
		else if (applicationInFocus == APP.CompApp2) languageTemplatesBasics_CompApp2.enterTextInField(valueCandidate, fieldName);
		else throw new RuntimeException("Unsupported application: " + applicationInFocus);
	}
	...
	{
		if (applicationInFocus == APP.CompApp1) languageTemplatesBasics_CompApp1.chooseInCombobox(valueCandidate, fieldName);
		else if (applicationInFocus == APP.CompApp2) languageTemplatesBasics_CompApp2.chooseInCombobox(valueCandidate, fieldName);
		else throw new RuntimeException("Unsupported application: " + applicationInFocus);
	}
	...
	{
		if (applicationInFocus == APP.CompApp1) languageTemplatesBasics_CompApp1.ensureCheckboxIsTicked(checkBoxDisplayName);
		else if (applicationInFocus == APP.CompApp2) languageTemplatesBasics_CompApp2.ensureCheckboxIsTicked(checkBoxDisplayName);
		else throw new RuntimeException("Unsupported application: " + applicationInFocus);
	}
	...
	{
		if (applicationInFocus == APP.CompApp1) languageTemplatesBasics_CompApp1.tickCheckboxForCondition(checkBoxDisplayName, actual, expected);
		else if (applicationInFocus == APP.CompApp2) languageTemplatesBasics_CompApp2.tickCheckboxForCondition(checkBoxDisplayName, actual, expected);
		else throw new RuntimeException("Unsupported application: " + applicationInFocus);
	}
	...
	{
		if (applicationInFocus == APP.CompApp1) languageTemplatesBasics_CompApp1.ensureCheckboxIsUNticked(checkBoxDisplayName);
		else if (applicationInFocus == APP.CompApp2) languageTemplatesBasics_CompApp2.ensureCheckboxIsUNticked(checkBoxDisplayName);
		else throw new RuntimeException("Unsupported application: " + applicationInFocus);
	}
	...
	{
		if (applicationInFocus == APP.CompApp1) languageTemplatesBasics_CompApp1.isTextDislayed(guiElementToRead, valueCandidate);
		else if (applicationInFocus == APP.CompApp2) languageTemplatesBasics_CompApp2.isTextDislayed(guiElementToRead, valueCandidate);
		else throw new RuntimeException("Unsupported application: " + applicationInFocus);
	}
	...
	{
		if (applicationInFocus == APP.CompApp2) languageTemplatesBasics_CompApp2.loginWith(username, password);
		else throw new RuntimeException("Unsupported application: " + applicationInFocus);
	}
