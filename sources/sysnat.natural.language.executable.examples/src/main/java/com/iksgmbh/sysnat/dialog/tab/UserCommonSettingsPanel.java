...
public class UserCommonSettingsPanel extends BasicTabPanel
{
	private static final long serialVersionUID = 1L;

	private JComboBox<String> cbxUseDialogSetting, cbxStartTabSetting, cbxResultLaunchOption;

	public UserCommonSettingsPanel(SysNatDialog aDialog)
	{
	...
	private void initGeneralSettingsComponents()
	{
		...
		cbxUseDialogSetting = initCombo(this, options1, yPos, getUseDialogDisplayValue(), NO_TOOLTIP, "cbxUseDialogSetting");
		...
		cbxStartTabSetting = initCombo(this, options2, yPos, getStartTabDisplayValue(), NO_TOOLTIP, "cbxStartTabSetting");
		...
		cbxResultLaunchOption = initCombo(this, options3, yPos, getLaunchOptionDisplayValue(), NO_TOOLTIP, "cbxResultLaunchOption");
